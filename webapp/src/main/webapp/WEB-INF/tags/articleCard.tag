...
<div class="card card-style text-dark bg-light ">
    <img src="https://www.sinrumbofijo.com/wp-content/uploads/2016/05/default-placeholder.png" class="card-img-top"
         alt="...">
    <div class="card-body">
        <h5 class="card-title" style="font-weight: bold"><c:out value="${title}"/></h5>
        ...
        <a href="article/${id}" class="btn btn-primary"><spring:message code="marketplace.articleCard.viewButton"/></a>
    </div>
</div>
</body>
</html>