                        ...
                        <div class="dropdown">
                            <a class="nav-link active color-grey dropdown-toggle h6" id="accountMenu"
                               data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                ...
                                <c:if test="${user.pendingRequestAmount > 0 || user.acceptedRequestAmount > 0 || user.declinedRequestAmount > 0}">
                                    <span class="badge bg-color-rentapp-red ms-1">${user.pendingRequestAmount + user.acceptedRequestAmount + user.declinedRequestAmount}</span>
                                </c:if>
                            </a>
