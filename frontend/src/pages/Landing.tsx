		...
		<Container className='d-flex flex-column align-items-center'>
			...
			<div className='py-2'>
				...
				{ratedIsSuccess && bestRated && (
					<ArticleCardList articlesPerRow={4} maxPage={1} articles={bestRated.data.slice(0, 4)} />
				)}
			</div>
			<div className='py-2'>
				<CategoriesList />
			...
			<div className='py-2'>
				...
				{rentedIsSuccess && mostRented && (
					<ArticleCardList articlesPerRow={4} maxPage={1} articles={mostRented.data.slice(0, 4)} />
				)}
			</div>
		</Container>
	);
