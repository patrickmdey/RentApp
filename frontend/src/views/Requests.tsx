...
export default function Requests() {
	...
	useEffect(() => setAcceptedAmount(user ? user.acceptedRequestAmount : 0), [user]);
	useEffect(() => setDeclinedAmount(user ? user.declinedRequestAmount : 0), [user]);
								...
								<Nav variant='pills' className='flex-column'>
									<Nav.Item>
										...
										>
											...
											{acceptedAmount + declinedAmount > 0 && (
												<p className='my-1'>
													<Badge className='bg-rentapp-red ms-1'>
														{acceptedAmount + declinedAmount}
													</Badge>
												</p>
											)}
										</Nav.Link>
					...
					<div className='col-md-9 col-lg-9 col-12 '>
						<Tab.Content>
							<Tab.Pane eventKey='first'>
								<SentRequestList acceptedAmount={acceptedAmount} declinedAmount={declinedAmount} />
							</Tab.Pane>
