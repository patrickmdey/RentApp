...
export default function PagesList(props: { pages: parse.Links | null; page: number; setPage: Function }) {
	...
	return (
		<div className='d-flex w-100 justify-content-center'>
			<Pagination>
				{page > firstPage && <Pagination.Prev onClick={() => setPage(page - 1)} />}
				{[...Array(amount)].map((_, idx) => (
					<Pagination.Item key={idx + 1} onClick={() => setPage(idx + 1)} active={page === idx + 1}>
						{idx + 1}
					</Pagination.Item>
				))}
