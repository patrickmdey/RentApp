...
function LoggedInNavBar(props: { userId: number; dispatch: Function }) {
    ...
    return (
        ...
        >
            ...
            <NavDropdown.Item
                onClick={() => navigate('profile')} className="d-flex align-content-center">
                <p>
            ...
            <NavDropdown.Item className="d-flex align-content-center"
                              onClick={() => dispatch(setCredentials({token: null, rememberMe: false}))}>
                <p><BsBoxArrowInLeft className="me-1"/></p>
                <p>
